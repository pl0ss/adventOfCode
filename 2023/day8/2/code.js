const input = `
...
const input_test2 = `LLR

AAA = (BBB, BBB)
BBB = (AAA, ZZZ)
ZZZ = (ZZZ, ZZZ)`

const input_test3 = `LR
...
function clac(input){
    [instructions, data] = parse_inpit(input);
    // console.log(instructions)

    next_arr = [];
    //? Suche alle nodes, welche mit A ende
...
function parse_inpit(input){
    ...
    for (let index = 2; index < lines.length; index++) {
        ...
        z = line.split(' = (')[1].split(', ')[1].replace(/\)/gi, '');
        data[x] = [y, z];
    }
